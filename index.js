...
console.log("### Challenge `makePersonObject`");
...
console.log("### Challenge `makeSmartPerson`");
console.log(makeSmartPerson("Joe").speak());
console.log(makeSmartPerson("Joe").sum(3, 7));
...
console.log("### Challenge `getCarInfoByIndex`");
...
console.log("### Challenge `getLastCarInfo`");
...
console.log("### Challenge `getCarInfoById`");
...
console.log("### Challenge `sortCarInventory`");
...
console.log("### Challenge `getModelYears`");
...
console.log("### Challenge `getOlderCars`");
...
console.log("### Challenge `getGermanCars`");
...
console.log("### Challenge refactor to arrow functions");
console.log(sum(5, 9));
console.log(addFive(7));
console.log(argTimesTwo(3));
...
console.log("### Challenge `carMaker` STRETCH GOAL");
console.log(carMaker(5));
console.log(carMaker(5).drive(9));
